...
from settings import API_KEY, BASE_URL_OW_FC

# Fonction pour chopper toutes la météo de toutes les villes


def get_city_weather():
    # Param for API call : lat={lat}&lon={lon}&exclude={part}&appid={API key}

    input_csv = "output/cities_fr.csv"
    output_csv = "output/cities_weather.csv"
    ...
    for _, row in cities_df.iterrows():
        ...
        response = rq.get(BASE_URL_OW_FC,params=parametre,timeout=5)
